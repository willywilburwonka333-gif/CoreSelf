...
export const defaultTools = [
  ...
  { id: 'image-generation-route', aliases: ['generate image', 'create image', 'image api'], name: 'Image Generation Route', category: 'Creator', status: 'Ready', permission: 'Ask first', capability: 'Generate images through the guarded /api/create-image server route using the existing OpenAI server key.', risk: 'Medium' },
  ...
  { id: 'provider-status-map', aliases: ['providers', 'api keys', 'connections', 'setup map'], name: 'Provider Status Map', category: 'Internal', status: 'Ready', permission: 'Allowed', capability: 'Show which AI/API providers are connected, missing, or blocked before Dylan claims a tool can run.', risk: 'Low' },
  { id: 'image-generation-provider', aliases: ['image api', 'images api', 'generate image'], name: 'Image Generation Provider', category: 'Creator', status: 'Needs setup', permission: 'Ask first', capability: 'Generate images through a future guarded server route after provider setup. Prompt creation works now.', risk: 'Medium' },
  { id: 'video-generation-provider', aliases: ['video api', 'generate video', 'film clip api'], name: 'Video Generation Provider', category: 'Creator', status: 'Needs setup', permission: 'Ask first', capability: 'Generate videos through a future guarded server route after provider choice and cost controls.', risk: 'High' },
  { id: 'music-generation-provider', aliases: ['music api', 'song api', 'voice api'], name: 'Music / Voice Provider', category: 'Creator', status: 'Needs setup', permission: 'Ask first', capability: 'Generate music, voice or narration after provider choice, rights review and server route setup. Prompts/lyrics work now.', risk: 'High' },
